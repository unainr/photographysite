    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor="#d3803c" />
              <stop offset="25%" stopColor="#e09043" />
              <stop offset="50%" stopColor="#be6b27" />
              <stop offset="75%" stopColor="#d3803c" />
              <stop offset="100%" stopColor="#e09043" />
            </>
          )}
        </linearGradient>
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="fill-transparent stroke-[#d3803c] font-[helvetica] text-5xl font-bold 
        dark:stroke-[#e09043]"
