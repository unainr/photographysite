...
export default function WhyChooseSection({ image, badge }: Props) {
	...
	return (
		<section className="py-12 md:py-20 lg:py-24 relative overflow-hidden bg-white dark:bg-slate-950">
			...
			<div className="container relative z-10 mx-auto px-4 sm:px-6 max-w-7xl">
				<div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
					...
					<div className="order-2 lg:order-1">
						<div className="relative h-[400px] sm:h-[500px] lg:h-[600px] rounded-xl md:rounded-2xl overflow-hidden group">
							...
							<div className="absolute bottom-4 sm:bottom-8 left-4 sm:left-8 right-4 sm:right-8 transform transition-transform duration-500 group-hover:-translate-y-2">
								<div className="backdrop-blur-xl bg-slate-900/80 p-4 sm:p-6 rounded-lg md:rounded-xl border border-[#e09043]/30 shadow-2xl">
					...
					<div className="order-1 lg:order-2">
						...
						<h2 className="mb-6 text-4xl md:text-5xl font-bold leading-tight text-slate-900 dark:text-white">
							Why Choose
						...
						<div className="space-y-4 mb-8">
							{features.map((point, index) => (
								<div
									key={index}
									className="flex items-start gap-4 p-5 rounded-xl border border-transparent hover:border-[#e09043]/50 transition-all duration-300 hover:bg-slate-100 dark:hover:bg-slate-900/80 hover:shadow-lg hover:shadow-[#e09043]/10 group cursor-pointer">
									...
									<p className="text-slate-600 dark:text-slate-300 leading-relaxed pt-2 group-hover:text-slate-900 dark:group-hover:text-white transition-colors duration-300">
										{point.text}
									</p>
								</div>
							))}
