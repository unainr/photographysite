...
export default function WhyChooseSection() {
  const equipmentImage = "/images/slider4.jpg";
  ...
  return (
    <section className="py-12 md:py-20 lg:py-24 relative overflow-hidden ">
      ...
      <div className="absolute bottom-10 md:bottom-20 right-5 md:right-10 w-48 h-48 md:w-96 md:h-96 bg-[#e09043] rounded-full blur-3xl opacity-10 animate-pulse" style={{ animationDelay: '1s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
              ...
              <div className="absolute bottom-4 sm:bottom-8 left-4 sm:left-8 right-4 sm:right-8 transform transition-transform duration-500 group-hover:-translate-y-2">
                <div className="backdrop-blur-xl bg-slate-900/80 dark:bg-slate-900/80 p-4 sm:p-6 rounded-lg md:rounded-xl border border-[#e09043]/30 shadow-2xl">
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div>
                      <div className="text-lg sm:text-2xl font-bold text-white dark:text-white">Award Winning</div>
                      <div className="text-xs sm:text-sm  text-slate-600">Excellence in Photography</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="order-1 lg:order-2 animate-fade-in">
            <div className="inline-block mb-4 px-4 py-2 rounded-full bg-[#e09043]/10 border border-[#e09043]/30">
              <span className="text-[#e09043] font-semibold text-sm tracking-wider uppercase">Why Choose Us</span>
            </div>
            ...
            <p className="mb-8 text-lg text-gray-300 leading-relaxed">
              With over a decade of experience capturing Dubai's most memorable moments, 
              we bring artistic vision, technical expertise, and unwavering commitment 
              to every project. Our passion for photography shines through in every frame.
            </p>
            ...
            {/* CTA Button */}
            <button className="px-8 py-4 bg-linear-to-r from-[#e09043] to-[#c47836] hover:from-[#f5a057] hover:to-[#e09043] text-white font-semibold rounded-xl shadow-lg shadow-[#e09043]/30 hover:shadow-xl hover:shadow-[#e09043]/50 transition-all duration-300 hover:scale-105 active:scale-95 relative overflow-hidden group">
