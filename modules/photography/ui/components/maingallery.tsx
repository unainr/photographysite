    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed inset-0 w-full min-h-screen  backdrop-blur-lg 
                          rounded-none sm:rounded-lg md:rounded-xl overflow-hidden z-90"
                ...
                <div className="h-full w-full flex flex-col">
                    <div className="flex-1 p-2 sm:p-3 md:p-4 flex items-center justify-center bg-gray-50/50">
                        <AnimatePresence mode="wait">
                            <motion.div
                                key={selectedItem.id}
                                className="relative w-full aspect-video max-w-[5%] sm:max-w-[85%] md:max-w-3xl 
                                         h-full rounded-lg overflow-hidden shadow-md"
            ...
            <motion.div
                ...
                className="fixed z-90 left-1/2 bottom-4 -translate-x-1/2 touch-none"
            >
                <motion.div
